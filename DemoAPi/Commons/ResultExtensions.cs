...
namespace Microsoft.AspNetCore.Http
{
	public static partial class ResultExtensions
	{
		...
		/// <returns></returns>
		public static Microsoft.AspNetCore.Http.IResult ToApiResponse<T>(this Result<T> result)
		{
			...
			return result is not Result ? Results.Ok(response) : ((IResult)result).ToApiResponse();
		}
		...
		/// <param name="result">The Ardalis.Result to convert to an Microsoft.AspNetCore.Http.IResult</param>
		/// <returns></returns>
		public static Microsoft.AspNetCore.Http.IResult ToApiResponse(this Result result)
		{
			return ((IResult)result).ToApiResponse();
		}

		internal static Microsoft.AspNetCore.Http.IResult ToApiResponse(this IResult result) =>
		...
		private static Microsoft.AspNetCore.Http.IResult Success(IResult result)
		{
